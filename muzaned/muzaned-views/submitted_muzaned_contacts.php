...
ON muzaned_details.clientId = contract_details.applicationID WHERE muzaned_details.muzanedStatus='booked' AND muzaned_details.softdeletestatus=1";
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="#updatemuzaned" class="btn btn-primary btn-sm lni " data-bs-toggle="modal"
                   data-muzaned-id="<?php echo $muzanedId; ?>"
                   data-client-id="<?php echo $applicantID; ?>"
