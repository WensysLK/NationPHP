  ...
  static get properties() {
    return {
      ...
      "src": {
        ...
        "docs": {
          "tags": [],
          "text": "Specifies the exact `assets` of an SVG file to use."
        },
        "attribute": "src",
        "reflect": false
      },
      "icon": {
        ...
        "docs": {
          "tags": [],
          "text": "A combination of both `name` and `assets`. If a `assets` url is detected\nit will set the `assets` property. Otherwise it assumes it's a built-in named\nSVG and set the `name` property."
        },
        "attribute": "icon",
        "reflect": false
      },
