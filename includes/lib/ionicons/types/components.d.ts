...
export namespace Components {
    interface IonIcon {
        ...
        "flipRtl"?: boolean;
        /**
          * A combination of both `name` and `assets`. If a `assets` url is detected it will set the `assets` property. Otherwise it assumes it's a built-in named SVG and set the `name` property.
         */
        "icon"?: any;
        /**
