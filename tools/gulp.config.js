        ...
        plugins: {
            global: {
                src: {
                    ...
                    optional: {
                        ...
                        bootstrapmaxlength: {
                            "scripts": [
                                "{$config.path.node_modules}/bootstrap-maxlength/assets/bootstrap-maxlength.js"
                            ]
                        },
                        daterangepicker: {
                            styles: [
                    ...
                    override: {
                        styles: ["{$config.path.assets}/sass/plugins.scss"],
                    },
                },
                dist: {
            ...
            custom: {
                ...
                formrepeater: {
                    src: {
                        scripts: [
                            "{$config.path.node_modules}/jquery.repeater/assets/lib.js",
                            "{$config.path.node_modules}/jquery.repeater/assets/jquery.input.js",
                            "{$config.path.node_modules}/jquery.repeater/assets/repeater.js"
                        ]
                    },
                    dist: {
        ...
        custom: {
            src: {
                styles: [
                    ...
                    "{$config.path.assets}/sass/custom/**/*.scss",
                ],
                scripts: [
                    "{$config.path.common_src}/js/custom/**/*.js",
                    "{$config.path.assets}/js/custom/**/*.js",
                ],
            },
            dist: {
