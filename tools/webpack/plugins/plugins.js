...
window.FormValidation.plugins.Bootstrap5 = require('@/assets/plugins/formvalidation/dist/amd/plugins/Bootstrap5.js').default;
...
require('bootstrap-maxlength/assets/bootstrap-maxlength.js');
...
require('@/assets/js/vendors/plugins/select2.init.js');
...
window.toastr = require('@/assets/plugins/toastr/build/toastr.min.js');
...
window.tns = require('tiny-slider/assets/tiny-slider.js').tns;
