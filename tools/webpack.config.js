...
const coreSrcPath = corePath + '/assets';
...
function getEntryFiles() {
    ...
    // Custom JS files from assets folder
    ...
    if (dev) {
        ...
        // Custom JS files from core assets folder
    ...
    if (args.indexOf('docs_html') !== -1) {
        entries['js/scripts.bundle'] = './' + path.relative('./', rootPath) + '/assets/js/scripts.js';
    }
...
function mainConfig() {
    return {
        ...
        resolve: {
            alias: {
                jquery: path.join(__dirname, 'node_modules/jquery/assets/jquery'),
                $: path.join(__dirname, 'node_modules/jquery/assets/jquery'),
                '@': [demoPath, corePath],
...
function getParameters() {
    var possibleArgs = [
        /**/'metronic', 'keen', 'start', 'craft', 'jet', 'rider', 'ceres', 'seven', 'good', 'star', 'open',/**/
        'js', 'css', 'scss',
    ...
    extraPlugins.push(new MergeIntoSingle({
        files: {
            'plugins/custom/datatables/datatables.bundle.js': [
                ...
                "../assets/js/vendors/plugins/datatables.init.js",
