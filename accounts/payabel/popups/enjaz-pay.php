...
<div class="modal fade" id="editLeadModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                        ...
                        <div class="col-6">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" name="paymentTpe" class="form-control" id="">
