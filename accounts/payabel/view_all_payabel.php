            ...
            <div class="card-body pd-y-30">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="processing" role="tabpanel" aria-labelledby="processing-tab">
                        ...
                        <?php include('paymenty-pendings/muzaned_payment_pending.php'); ?>

                    </div>
                    <div class="tab-pane fade" id="completed" role="tabpanel" aria-labelledby="completed-tab">

                    <?php include('paymenty-pendings/view_departured_applications.php'); ?>
                    </div>
                    <div class="tab-pane fade" id="deported" role="tabpanel" aria-labelledby="deported-tab">
                        <?php include('paymenty-pendings/fingerPrint_payment_pending.php'); ?>
