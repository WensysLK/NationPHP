                        ...
                        <div class="col-6">
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="date" name="allocationdate" class="form-control" id="" value="<?php echo $formattedAllocationDate ?>">
                                </div>
                                <div class="col">
                                    <label for="gccdate">Gcc Date:</label>
                                    <input type="date" name="gccDate" class="form-control" id="" value="<?php echo $formattedGccDate ?>">
