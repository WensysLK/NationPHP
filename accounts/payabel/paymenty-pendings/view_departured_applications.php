<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlmedical = "SELECT bureau_details.bureauId,bureau_details.*, 
...
FROM bureau_details
JOIN applications 
ON bureau_details.clientId = applications.applicationID
JOIN contract_details
ON bureau_details.clientId = contract_details.applicationID WHERE bureau_details.bureaustatus='processing' AND bureau_details.softdeletestatus=1";
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $muzaned_date; ?></td>

            <td>
                <a href="#bureau" class="btn btn-primary btn-sm lni "
                   ...
                   data-finger-id="<?php echo $bureauId; ?>"
                   data-finger-booking-date="<?php echo $muzaned_date; ?>">
    ...
    <?php 
            ...
            echo "<div class='alert alert-primary mt-2' role='alert'> No Pending Bureau Payments!</div>";
        }
    } ?>
</table>


<div class="modal fade" id="bureau" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content tx-14">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel4">Book Bureau</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"></span>
                </button>
            </div>
            <div class="modal-body">
                <form action="functions/add-bureau-payment.php" method="POST"
                    ...
                    <input type="hidden" name="bureauId" value="<?php echo $bureauId ?>" id="bureauId">
                    <div class="row">
                        <div class="col-4">
                        ...
                        <div class="col-6">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="muzaned_date" class="form-control" id="medidob"
                                           readonly value="<?php echo $muzaned_date  ?>">
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary mt-2" name="submit">Book Bureau</button>
