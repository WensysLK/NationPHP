    ...
    <tbody>
        <?php
            while ($row = mysqli_fetch_assoc($resmedical)) {
                ...
                $serial_no = $row['muzaned_SI'];
                $muzaned_date = $row['muzaned_date'];
        ...
        <tr>
            ...
            <td>
                <a href="#fingerPrint" class="btn btn-primary btn-sm lni "
                   ...
                   data-finger-id="<?php echo $muzanedId; ?>"
                   data-system-type="<?php echo $serial_no; ?>"
...
<div class="modal fade" id="fingerPrint" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content tx-14">
            ...
            <div class="modal-body">
                <form action="functions/add-muzaned-payment.php" method="POST"
                    ...
                    <input type="hidden" name="muzanedId" value="<?php echo $muzanedId ?>" id="fprintId">
                    <div class="row">
                        <div class="col-4">
                        ...
                        <div class="col-6">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col">
                                    <label for="medidob" class="form-label">Muzaned Booking Date</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="clientname" class="form-label">Serial No</label>
                                    <input type="text" name="clinetName" class="form-control" id="clientmedicalfname"
                                           readonly value="<?php echo $serial_no  ?>">
                            ...
                            <button type="submit" class="btn btn-primary mt-2" name="submit">Book Muzaned</button>
