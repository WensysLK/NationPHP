    ...
    <tbody>
        <?php
            while ($row = mysqli_fetch_assoc($resmedicalprocessing)) {
                ...
                $allocationDateNew = $row['allocationDate'];
                $gccDate = new DateTime($row['gccDate']);
                $gccDateNew = $row['gccDate'];
        ...
        <tr>
            ...
            <td>
                <a href="medicle_booking_view.php?client_id=<?php echo $applicantID;?>" class="btn btn-primary btn-sm lni "
