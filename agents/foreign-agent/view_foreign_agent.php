...
$query = "SELECT * FROM foreign_agent_details WHERE fagentId = ?";
...
$querynew = "SELECT * FROM attachemnts_data_iqama WHERE attachemnet_ClientID = ? ORDER BY createdAt DESC 
LIMIT 1";
...
$querynewLicense = "SELECT * FROM attachemnts_data_license WHERE forigen_agent_id = ? ORDER BY createdAt DESC 
LIMIT 1";
...
$querynewIdbr = "SELECT * FROM attachemnts_data_idbr WHERE forigen_agent_id = ? ORDER BY createdAt DESC 
LIMIT 1";
...
$querynewAttacment = "SELECT * FROM attachemnts_data WHERE attachemnet_ClientID = ? ORDER BY createdAt DESC 
LIMIT 1";
...
$query_company = "SELECT * FROM forginagent_company_details WHERE fagentID = ?";
...
<body>
    ...
    <div class="content content-fixed bd-b">
        <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
            ...
            <div class="content">
                <form method="POST" action="form-parts-insert/foreign_agent_data_edit.php"
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <?php if($guardian['fagentType']==="Recruitment_Company") {?>
                                    ...
                                    <?php }elseif($guardian['fagentType']=="company") {?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="agentType" type="radio" class="form-control"
                                    ...
                                    <?php }elseif($guardian['fagentType']=="Individual") {?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="agentType" type="radio" class="form-control"
                                               name="inlineRadioOptions" id="inlineRadio1" value="Recruitment_Company" >
                                        <label class="form-check-label" for="inlineRadio1">Recruitment Company</label>
                                    ...
                                    <?php }elseif($guardian['fagentType']=="coporatecompany") {?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="agentType" type="radio" class="form-control"
                                               name="inlineRadioOptions" id="inlineRadio1" value="Recruitment_Company" >
                                        <label class="form-check-label" for="inlineRadio1">Recruitment Company</label>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="agentType" type="radio" name="inlineRadioOptions"
                                               id="inlineRadio4" value="coporatecompany"checked>
                                        <label class="form-check-label" for="inlineRadio3">Coperate Company</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="agentType" type="radio" name="inlineRadioOptions"
                                    ...
                                    <?php }elseif($guardian['fagentType']=="direct") {?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="agentType" type="radio" class="form-control"
                                               name="inlineRadioOptions" id="inlineRadio1" value="Recruitment_Company" >
                                        <label class="form-check-label" for="inlineRadio1">Recruitment Company</label>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="agentType" type="radio" name="inlineRadioOptions"
                                               id="inlineRadio5" value="direct"checked>
                                        <label class="form-check-label" for="inlineRadio3">Direct</label>
                                    </div>
                                    <?php } ?>
                                </div>
                            </div>
                            <input type="hidden" name="agentId" value="<?php echo $localagentId; ?>">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    ...
                                    <select name="name-title" class="form-control" id="exampleFormControlSelect1">
                                        <?php if($guardian['fagentTitle']=="Dr") {?>
                                            <option Value="Dr" selected>Dr</option>
                                            <option Value="Mr">Mr</option>
                                            <option Value="Mrs">Mrs</option>
                                            <option Value="Ms">Ms</option>
                                        <?php } elseif($guardian['fagentTitle']=="Mr") {?>
                                            <option Value="Dr">Dr</option>
                                            <option Value="Mr"selected>Mr</option>
                                            <option Value="Mrs">Mrs</option>
                                            <option Value="Ms">Ms</option>
                                        <?php } elseif($guardian['fagentTitle']=="Mrs") {?>
                                            <option Value="Dr">Dr</option>
                                            <option Value="Mr">Mr</option>
                                            <option Value="Mrs"selected>Mrs</option>
                                            <option Value="Ms">Ms</option>
                                        <?php } elseif($guardian['fagentTitle']=="Ms") {?>
                                            <option Value="Dr">Dr</option>
                                            <option Value="Mr">Mr</option>
                                            <option Value="Mrs">Mrs</option>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" name="ownerFname" class="form-control" id="ownerFname" value="<?php echo $guardian['fagentFname']?>">
                                </div>
                                <div class="col-3">
                                    <label for="ownerMname" class="form-label">Middle Name</label>
                                    <input type="text" name="ownerMname" class="form-control" id="ownerMname" value="<?php echo $guardian['fagentMname']?>">
                                </div>
                                <div class="col-4">
                                    <label for="ownerLname" class="form-label">Last Name</label>
                                    <input type="text" name="ownerLname" class="form-control" id="ownerLname" value="<?php echo $guardian['fagentLname']?>">
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="col  ">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="1234 Main St"
                                           name="fagentddress1"value="<?php echo $guardian['adressline_1']?>">
                                </div>
                                <div class="col  ">
                                    <label for="Address2">Address 2</label>
                                    <input type="text" class="form-control" id="" placeholder="Apartment, studio, or floor"
                                           name="fagentaddress2"value="<?php echo $guardian['addressline2']?>">
                                </div>
                                <div class="col">
                                    <label for="City">City</label>
                                    <input type="text" class="form-control" id="" name="fagentcity"value="<?php echo $guardian['city']?>">
                                </div>
                                <div class="col">
                                    <label for="Province">Province / State</label>
                                    <input type="text" class="form-control" id="" name="fagentprovince"value="<?php echo $guardian['provinecs']?>">
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="text" name="iqamaNumber" class="form-control" id="iqamaNumber" value="<?php echo $guardian['fagentIqamaNo']?>">
                                </div>
                                <div class="col">
                                    <label for="iqamaCopy" class="form-label">IQAMA Copy</label>
                                    <img id="preview" src="<?php echo $baseUrl.'/uploads/agents/IQA/'. $imagesid_back['attachFilename'] ?>" alt="Profile Image" style="width: 100px;height: 100px">
<!--                                    <input type="file" name="iqamaNumber" class="form-control" id="iqamaCopy">-->
                                </div>
                                <div class="col">
                                    <label for="OwnerWhatzapp" class="form-label">Whatzapp No</label>
                                    <input type="text" name="ownerWhatzapp" class="form-control" id="ownerWhatzapp"value="<?php echo $guardian['fagentWhatzapp']?>">
                                </div>
                                <div class="col">
                                    <label for="ownerEmail" class="form-label">Email</label>
                                    <input type="text" name="ownerEmail" class="form-control" id="ownerEmail" value="<?php echo $guardian['fagentEmail']?>">
                                </div>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col">
                            ...
                            <img id="preview" src="<?php echo $baseUrl.'/uploads/agents/FBrCopy/'. $imagesid_Idbr['attachFilename'] ?>" alt="Profile Image" style="width: 100px;height: 100px">
<!--                            <input type="file" name="attachbBrcopy" class="form-control" id="attachbBrcopy">-->
                        ...
                        <div class="col">
                            ...
                            <img id="preview" src="<?php echo $baseUrl.'/uploads/agents/foreignLicenseCopy/'. $imagesidLicense['attachFilename'] ?>" alt="Profile Image" style="width: 100px;height: 100px">
...
<!--                            <input type="file" name="licenseCopy" class="form-control" id="licenseCopy">-->
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col  ">
                            <label for="Address2">Address 2</label>
                            <input type="text" class="form-control" id="" placeholder="Apartment, studio, or floor"
                                name="fagentaddress2" value="<?php echo $company['AddressLine1']?>">
                        </div>
                        <div class="col">
                            <label for="City">City</label>
                    ...
                    <div class="row mt-2">
                        <div class="col  ">
                            ...
                            <select class="form-select" aria-label="Default select example" id="" name="status">
                                <?php if ($guardian['status'] == "pending"){ ?>
                                    <option value="pending" selected>Pending</option>
                                    <option value="completed">Completed</option>
                                <?php }elseif($guardian['status'] == "completed"){ ?>
                    ...
                    <div class="row mt-2">
                        <div class="col">
                            ...
                            <textarea name="fAgentRemark" id="" class="form-control" cols="80" rows="4"><?php echo $guardian['fagentRemark']?></textarea>
                        </div>
                        <div class="col">
                            ...
                            <textarea id="mapEmbedCode" name="mapEmbedCode" class="form-control" rows="4"
                                      cols="50"><?php echo $guardian['fagentMap']?></textarea>
                        </div>
                    </div>
                    <!-- Repeater Section -->
                    <div class="row mt-3">
