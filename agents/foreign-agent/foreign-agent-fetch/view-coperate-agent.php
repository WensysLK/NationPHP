<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlapplication = "
        ...
        ON 
            forginagent_company_details.fagentID = foreign_agent_details.fagentId WHERE forginagent_company_details.softdeletestatus = 1 AND foreign_agent_details.fagentType = 'coporatecompany'
    ";
