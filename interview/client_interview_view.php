...
$sql_new = "SELECT * FROM interviews_details WHERE application_id=$client_id";
$res_new = mysqli_query($conn,$sql_new);
if($row_new = mysqli_fetch_assoc($res_new)){
    $appearance = $row_new['appearance'];
    $communications= $row_new['communications'];
    $confidence = $row_new['confidence'];
    $experience = $row_new['experience'];
    $attitude = $row_new['attitude'];
    $read = $row_new['read'];
    $understand = $row_new['understand'];
    $speak= $row_new['speak'];
    $status = $row_new['status'];
    $evaluatedBy = $row_new['evaluatedBy'];
    $register_date = $row_new['register_date'];
}
...
<!--                        </div>-->
                ...
                <div class="row mb-5">
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($appearance=="excellent"){?>
                        <div class="wslk-radio">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="male" name="appearance" value="excellent" checked>
                        ...
                        <?php }elseif ($appearance=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="appearance" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <?php } elseif ($appearance=="average"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="appearance" value="average" checked>
                                    <label class="form-check-label" for="male">
                                        Average
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($appearance=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="appearance" value="excellent" >
                                    <label class="form-check-label" for="male">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="appearance" value="belowAverage" checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                    ...
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($communications=="excellent"){?>

                        <div class="wslk-radio">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="male" name="communications" value="excellent" checked>
                                <label class="form-check-label" for="male">
                                    Excellent
                                </label>
                            </div>
                        ...
                        <?php } elseif ($appearance=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="communications" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <div class="wslk-radio">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="male" name="communications" value="average"checked>
                                <label class="form-check-label" for="male">
                                    Average
                                </label>
                            </div>
                        ...
                        <?php }elseif ($appearance=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="communications" value="belowAverage" checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                    ...
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($confidence=="excellent"){?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="confidence" value="excellent" checked>
                                    <label class="form-check-label" for="male">
                                        Excellent
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($confidence=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="confidence" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <?php } elseif ($confidence=="average"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="confidence" value="average" checked>
                                    <label class="form-check-label" for="male">
                                        Average
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($confidence=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="confidence" value="excellent">
                                    <label class="form-check-label" for="male">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="confidence" value="belowAverage" checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($experience=="excellent"){?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="experience" value="excellent" checked>
                                    <label class="form-check-label" for="male">
                                        Excellent
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($experience=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="experience" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <?php } elseif ($experience=="average"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="experience" value="average" checked>
                                    <label class="form-check-label" for="male">
                                        Average
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($experience=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="experience" value="excellent">
                                    <label class="form-check-label" for="male">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="experience" value="belowAverage" checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                    ...
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($attitude=="excellent"){?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="attitude" value="excellent" checked>
                                    <label class="form-check-label" for="male">
                                        Excellent
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($attitude=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="attitude" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <?php } elseif ($attitude=="average"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="attitude" value="average" checked>
                                    <label class="form-check-label" for="male">
                                        Average
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($attitude=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="attitude" value="excellent">
                                    <label class="form-check-label" for="male">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="attitude" value="belowAverage" checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                ...
                <div class="row mb-5">
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($read=="excellent"){?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="read" value="excellent" checked>
                                    <label class="form-check-label" for="male">
                                        Excellent
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($read=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="read" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <?php } elseif ($read=="average"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="read" value="average" checked>
                                    <label class="form-check-label" for="male">
                                        Average
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($read=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="read" value="belowAverage"checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                    ...
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($understand=="excellent"){?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="understand" value="excellent" checked>
                                    <label class="form-check-label" for="male">
                                        Excellent
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($understand=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="understand" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <?php } elseif ($understand=="average"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="understand" value="average" checked>
                                    <label class="form-check-label" for="male">
                                        Average
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($understand=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="understand" value="excellent">
                                    <label class="form-check-label" for="male">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="understand" value="belowAverage" checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                    ...
                    <div class="col-4 mt-2">
                        ...
                        <?php if ($speak=="excellent"){?>
                            <div class="wslk-radio">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="speak" value="excellent" checked>
                                    <label class="form-check-label" for="male">
                                        Excellent
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($speak=="good"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="speak" value="good" checked>
                                    <label class="form-check-label" for="female">
                                        Good
                                    </label>
                                </div>
                        ...
                        <?php } elseif ($speak=="average"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" id="male" name="speak" value="average" checked>
                                    <label class="form-check-label" for="male">
                                        Average
                                    </label>
                                </div>
                        ...
                        <?php }elseif ($speak=="belowAverage"){ ?>
                            <div class="wslk-radio">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input " type="radio" id="female" name="speak" value="belowAverage" checked>
                                    <label class="form-check-label" for="female">
                                        Below Average
                                    </label>
                                </div>
                ...
                <div class="row mb-5">
                    <div class="col-4 mt-2">
                        ...
                        <select  class="form-control" id="exampleFormControlSelect1" name="status">
                            ...
                            <?php }elseif ($status=="Incompleted"){?>
                                <option Value="completed" >Completed</option>
                                <option Value="Incompleted" selected>Rejected</option>
                            <?php } ?>
                        </select>
...
<!--                        <input type="hidden" class="form-control" name="statusyu" >-->
                    ...
                    <div class="col-4 mt-2">
                        ...
                        <input type="text" class="form-control" name="evaluatedBy" value="<?php echo $evaluatedBy?>">
                    </div>

                    <div class="col-4 mt-2">
                        <label class="form-label">Date</label>
                        <input type="date" class="form-control" name="date" id="" value="<?php echo $register_date?>" >
                    </div>
