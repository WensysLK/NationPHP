<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlmedical="SELECT contract_details.*, 
                   ...
                   WHERE contract_details.ContractStartus = 'started' 
                     AND contract_details.softdeletestatus = 1 AND contract_details.interviewStatus='incompleted';";
        ...
        if ($count_rows > 0) { ?>
            ...
            while ($row = mysqli_fetch_assoc($resmedical)) {
                ...
                <tr>
                    ...
                    <td>
<!--                        <a  href="client_interview_incomplet.php?client_id=--><?php //echo $applicantID;?><!--" class="btn btn-primary btn-sm lni ">-->
