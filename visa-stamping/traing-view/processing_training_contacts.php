<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlmedical = "SELECT contract_details.contractId, contract_details.ContractStartus, 
                   ...
                   WHERE  training_details.softdeletestatus = 1 AND training_details.trainnigStatus='pending'";
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form action="functions/training_data_edit.php" style="display: inline-block;" method="POST">
