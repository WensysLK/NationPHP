                                ...
                                <div class="col-12 col-lg-4 border-right">
                                    <div class="d-md-flex align-items-center">
                                        ...
                                        <div class="ms-md-4 flex-grow-1">
                                            ...
                                            <a type="button" class="btn btn-primary"  target="_blank" href="<?php echo $baseUrl; ?>/applications/profile-view/generatePDF.php?client_id=<?php echo $client_id;?>">Download</a>
                                            <a type="button" class="btn btn-outline-secondary ml-2" target="_blank" href="<?php echo $baseUrl; ?>/applications/profile-view/resume.php?client_id=<?php echo $client_id;?>">Resume</a>
                                        </div>
                                    </div>
                                </div>
