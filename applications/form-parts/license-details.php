    ...
    <div id="licenseContainer">
        <div class="row licenseGroup">
            <div class="col">
                ...
                <select name="licensetype[]" class="form-select form-control" >
...
<!--                <input type="text" class="form-control" name="licensetype[]" id="">-->
            ...
            <div class="col">
                <label>Country</label>
                <select name="licensecountry[]" class="form-select form-control countrySelectNew">
            ...
            <div class="col">
                ...
                <select name="licenseexpirey[]" class="form-select form-control" >
                    <option value="none" selected >Select</option>
...
document.addEventListener('DOMContentLoaded', function () {
    const firstCountrySelect = document.querySelector('.countrySelectNew');
