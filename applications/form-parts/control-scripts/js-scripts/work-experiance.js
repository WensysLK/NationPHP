    ...
    experienceEntry.innerHTML = `
                        <hr style="margin-top:20px;margin-bottom:20px;">
                                    ...
                                    <div class="col p-2">
                                        ...
                                        <input class="form-control newYearstart" type="date" name="yearstart[]" id="yearstartNew">
                                    </div>
                                        <div class="col p-2">
                                        <label class="form-label">Job End</label>
                                        <input class="form-control newYearEnd" type="date" name="yearEnd[]" id="yearEndNew" onchange="getYearsNew()">
                                        </div>
                                          <div class="col p-2">
                                              <label class="form-label">Years</label>
                                              <input class="form-control" type="text" id="${yearsNew}" name="years[]">
                                        <input class="form-control yearname" type="hidden" id="yearname" name="years[]" value="${yearsNew}">
