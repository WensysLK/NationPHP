...
<!--                                    <option value="foreignAgent">Foreign Agent</option>-->
                                ...
                                <label for="message" class="form-label">Last Procedure take for the complaint:</label>
                                <textarea name="procedure_processing" class="form-control" required><?php echo $row['last_procedure']?></textarea><br>
                                <label for="message" class="form-label">Complain Status:</label>
